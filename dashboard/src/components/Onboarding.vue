<template>
	<div class="mx-auto max-w-2xl rounded-lg border-0 px-2 sm:border sm:p-8">
		<div class="prose prose-sm max-w-none">
			<h1 class="text-2xl font-semibold">Welcome to Sowaan Cloud</h1>
			<p>
				Sowaan Cloud makes it easy to manage sites and apps like ERPNext in an
			...
			<div v-if="pendingSiteRequest">
				...
				<div class="mt-2 pl-7" v-if="pendingSiteRequest.status == 'Error'">
					<p class="mt-2 text-p-base text-ink-gray-8">
						Please contact Sowaan Cloud support by clicking on the button below.
					</p>
